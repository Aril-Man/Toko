                    ...
                    <div class="col-6">
                            <strong>Nama Barang:</strong>
                                <select class="form-control" name="id_barang" id="id_barang">
                                    ...
                                    <option value="{{ $item->id }}" data-harga="{{$item->harga_barang}}" data-stok="{{$item->stok_barang}}">{{ $item->nama_barang }}</option>
                                    @endforeach
                                </select>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-6"><label for="id_user" class="form-control-label">ID User</label><input name="id_user" id="id_user" value="{{auth()->user()->name}}" type="text" placeholder="Masukan User" class="form-control" readonly></div>
                    <div class="col-6"><label for="jumlah_beli" class="form-control-label">Jumlah Beli</label><input name="jumlah_beli" id="jumlah_beli" type="number" placeholder="Masukan Jumalah Beli" class="form-control"></div>
                </div>
                <div class="row form-group">
