        ...
        <div class="card">
            <div class="card-header">
                <div class="pull-right">
                    <a class="btn btn-success" href="{{ route('admin.create_distributor') }}"> Tambah Distributor</a>
                </div>
            </div>
                ...
                <tr>
                        ...
                        <td>
                            <form action="#" method="POST">
                                ...
                                <a class="btn btn-primary" href="{{route ('admin.edit_distributor',$distri->id) }}">Edit</a>
