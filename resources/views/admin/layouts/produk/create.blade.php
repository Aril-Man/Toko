    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="" method="post" class="form-horizontal">
                ...
                <div class="row form-group">
                    <div class="col-6"><label for="harga_barang" class="form-control-label">Harga Barang</label><input name="harga_barang" id="harga_barang" type="number" placeholder="Masukan Harga Barang" class="form-control"></div>
